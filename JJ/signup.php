...
<body class="h-screen bg-cover bg-no-repeat flex items-center justify-center font-[Roboto]" style="background-image: url('pic/social-media.webp'); background-position: center calc(100% + 100px); font-family: 'Roboto', Arial, sans-serif;">
    ...
    <div id="signup-form-container" class="p-8 rounded-lg shadow-lg w-full max-w-lg mx-auto mt-24 backdrop-filter backdrop-blur-2xl">
        <form id="signupFormActual" action="#" method="POST">
            ...
            <div class="mb-4 border-t pt-4">
                <label for="signup-student_id" class="block text-white text-sm font-bold mb-2">Account</label>
