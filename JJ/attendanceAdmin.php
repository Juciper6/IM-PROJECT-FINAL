            ...
            <div class="flex justify-between items-center py-3 relative">
                <div class="flex items-center space-x-3">
                    ...
                    <div class="text-lg font-bold text-gray-800 hidden sm:block">
                        <span class="text-sm">ADMIN DASHBOARD [ J & J SOCIAL PLATFORM ] - </span>
                    </div>
                </div>
                ...
                if (empty($sections)) {
                    ...
                    foreach ($sections as $section) {
                        ...
                        try {
                            ...
                            echo "<h2 class='text-center text-xl md:text-2xl font-semibold text-gray-700 mb-4'>Section: " . $currentSectionDisplay . " (<span class='font-mono'>" . count($results) . "</span>Users)</h2>";
